...
void cf_init(void)
{
    ...
    cf_create_string_item("romrcdir","Use STRING as romrc.d directory",'d',DATA_DIRECTORY"/romrc.d");
    ...
    cf_create_int_item("overclock","Overclock the 68k by N%",0,0);
